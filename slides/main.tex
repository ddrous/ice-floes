...
\colorlet{mygray}{gray!92!blue} 
\colorlet{mywhite}{white!98!black} 
\colorlet{myred}{red!90!black} 
\colorlet{myblack}{black!2}
\definecolor{myblack2}{RGB}{27,55,61}
\definecolor{navy}{rgb}{0.04706, 0.13725, 0.26667}
\definecolor{mLightBrown}{HTML}{EB811B}

% \usefonttheme{structuresmallcapsserif}

\usecolortheme[named=myblack2]{structure}
...
\usepackage{etoolbox}
\usepackage{listings}
\lstset{basicstyle=\ttfamily, keywordstyle=\bfseries\color{mygreen}, frame=single}

\usepackage{xcolor}
\usepackage{graphicx}
\graphicspath{ {../reports/internship/Figures/} {../code/simu1D/frames/}}
\usepackage[xetex]{animate}
\usepackage{changepage}  %% To increase the size of the margin
...
%urlcolor=orange,% The color of hyperlinks (URLs)
%}
...
\newcommand{\myfigframesize}[3]{
  \begin{figure}       
    \frame{\includegraphics[width=.#3\textwidth]{#1}}       
    \caption{#2}
  \end{figure}
}
...
\newcommand{\avgzero}{\mbox{\normalfont\large\bfseries 0}}
\newcommand{\rvline}{\hspace*{-\arraycolsep}\vline\hspace*{-\arraycolsep}}

%%------------- New emoji redefinitions ------------------------
\newcommand{\myemoji}{%
  \begingroup\normalfont
  \includegraphics[height=\fontcharht\font`\B]{pointing-right.png}%
  \endgroup
}
%-------------------------------------------------------------------------------
%							TITLE PAGE
...
\logo{\includegraphics[width=0.6cm,height=1.2cm,keepaspectratio]{LogoLJLL.jpg}}

\date[Soutenance de fin de stage 2021]{Soutenance de fin de stage\\\DTMdisplaydate{2021}{08}{26}{-1}}
