...
%\setmainfont[BoldFont={Meta Serif Pro Bold}, 
%ItalicFont={Meta Serif Pro BookIta},
%BoldItalicFont={Meta Serif Pro BoldIta}
%]{Meta Serif Pro Light} % Note the O
%\setromanfont{Meta Serif Pro}
%\setsansfont{Fira Sans}
%\setmonofont[Color={0019D4}]{Fira Code}
...
\newcommand{\hplus}{h_{+}}
\newcommand{\hmoins}{h_{-}}
\newcommand{\eun}{e_1(\omega)}
\newcommand{\edeux}{e_2(\omega)}
%-----------------------------------------------------------------------
...
%% TikZit custom styles
\tikzstyle{newstyle}=[-,draw=Green,line width=2.000]  %% You need to replace with whatever definition you are using
...
\newcommand{\bvec}[1]{\mathbf{#1}}  %% Use this to make you vectors look bolded
...
%% Stupid characters to declare if you your code to compile
...
% \renewcommand{\today}{\DTMdate{2021-1-27}}
...
\thesistitle{Fracturation de floes de glace par percution dans un modèle granulaire} % Your thesis title, ths is used in the title and abstract, print it elsewhere with \ttitle
...
\author{Desmond Roussel \textsc{Nzoyem}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\begin{figure}[!htb]
   \begin{minipage}{0.32\textwidth}
     \centering
     \includegraphics[width=.8\linewidth]{LogoUnistra.jpg}
...
\textit{initié par le groupe \groupname au \href{https://www.ljll.math.upmc.fr/?lang=fr}{LJLL}.}\\[0.2cm]
...
\include{Chapters/Chapter2}     %% Roadmap
\include{Chapters/Chapter3}       %% Results
\include{Chapters/Chapter4}       %% Milestones
\include{Chapters/Chapter5}     %% Summary   
