...
Cette semaine le travail a consisté en la compréhension des notions de processus stochastiques. Bien que des avancées ont été faites sur ce plan, il reste des points à revoir. J'ai aussi lu le dernier chapitre de la thèse afin de localiser les théorèmes et propositions les plus utilisés, afin de les maitriser en priorité. La semaine 6 consistera en la relecture des chapitres 4, 5, et 6 en espérant cette fois une bien meilleure compréhension.
...
\begin{enumerate}
  \item Essaie de lecture du chapitre 4 du livre \parencite{balasoiu2020halthesis}.
  ...
  \item Essaie de lecture du chapitre 5 du livre \parencite{balasoiu2020halthesis}.
  \item Lecture du chapitre 6 du livre \parencite{balasoiu2020halthesis}.
\end{enumerate}
...
\textit{Quelque questions afin de faciliter le relecture.}

\begin{enumerate}
  \item Dans le chapitre 4 \parencite[p.113]{balasoiu2020halthesis}, le processus stochastique $\Phi$ est défini comme une variable aléatoire (une fonction de $\mathcal{A}$ vers $\mathbb{N}$ ?). Et donc lorsqu'on écrit $\text{Card }\Phi$, s'agit-il de $\text{Card (Im }\Phi)$ ?
  ...
  \item Dans l'équation qui décrit le système dynamique (SE) \parencite[p.188]{balasoiu2020halthesis}, est-ce que ce n'est pas plutôt $\bvec{u}_{0j}$ qu'il faut utiliser partout ? De plus, la sommation ne devrait-elle pas plutôt se faire sur l'indice $j$ ?
\end{enumerate}
