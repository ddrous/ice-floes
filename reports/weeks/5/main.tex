...
\begin{enumerate}
  ...
  \item Dans l'équation qui décrit le système dynamique (SE) \parencite[p.188]{balasoiu2020halthesis}, est-ce que ce n'est pas plutôt $\bvec{u}_{0j}$ qu'il faut utiliser ? De plus, la sommation ne devrait-elle pas se faire sur l'indice $j$ plutôt ?
\end{enumerate}
