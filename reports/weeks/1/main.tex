...
\begin{enumerate}
  \item Rajouter le caratère déformable aux floes dans le modèle granulaire \parencite[p.12]{rabatel:tel-01293341}.
  \item Vu que le coefficient de détermination est fixé de facon empirique, on pourrait déterminer ce coefficient en fonction de l’endommagement subi par le floe et des éventuelles fractures se propageant dans le floe à partir d’une situation de collision \parencite[p.14]{rabatel:tel-01293341}.
