...
\subsubsection*{Modélisation et simulation 1D (collision parfaitement inélastique)}
...
\begin{figure}[!h]
    ...
    \caption{Simulation de la percussion 1D entre deux floes avec $m=1$, $m'=1$, $k=16$, $k'=5$, $\mu=6$,
        $\mu'=2$, $v_0=-1.0$, $t_{max}=32$. On observe effectivement le ralentissment du systène et une convergence
