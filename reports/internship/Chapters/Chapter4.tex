...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{SimuPercussion1D.png}
    \caption{Simulation de la percussion 1D entre deux floes avec $m=1.0$, $m'=1.0$, $k=2.0$, $k'=1.0$, $mu=1.0$, $mu'=2.0$, $v_0=-1.0$, $t_{max}=2.0$.}
