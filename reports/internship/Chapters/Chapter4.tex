...
\end{align}
Afin d'éviter toute confusion, nous notons $v_2 = \dot{x}_2(\tmoins)$ et $v_3 = \dot{x}_3(\tmoins)$ les vitesses des noeuds en contact avant collision, et $V_2 = \dot{x}_2(\tplus)$ et $V_3 = \dot{x}_3(\tplus)$ les vitesses après contact. L'équation \cref{eq:debuteq1} devient donc:
\begin{align} \label{eq:crammer1}
    mV_2 + m'V_3 = I + mv_2 + m'v_3
\end{align}
À présent, nous pouvons étudier l'énergie cinétique du système à travers le coefficient de restitution $\varepsilon$ \footnote{Le coefficient de restitution est le même que celui utilisé dans la thèse \parencite{rabatel2015thesis}.}. On l'équation
\begin{align} \label{eq:crammer2}
    V_2 - V_3 = \varepsilon (v_2 - v_3)
\end{align}
Le système de Cramer qui découle des \cref{eq:crammer1,eq:crammer2} permet d'obtenir les expressions:
\begin{align}
    V_2 = \frac{I + (m+\varepsilon m')v_2 + (1-\varepsilon)m'v_3}{m+m'} \,, \quad V_3 = \frac{I + (1-\varepsilon)mv_2 + (m'+\varepsilon m)v_3}{m+m'} \,.
\end{align}
