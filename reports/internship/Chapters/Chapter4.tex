...
et $p_0$ de la section précédente à leur masses respectives $m$ et $m'$ (voir \cref{fig:contact1d}).
\begin{figure}[!h]
    \centering
...
$m+m'$ dont
le déplacement des donné par la variable $x_1$. Le déplacement de la masse $m'$ à l'autre bout du système est nommé
$x_1$. La masse $m$ fixée au mur ne sera pas étudiée ici. Nous faisons à présent le bilan des forces qui s'exercent ces
deux masses.
\begin{figure}[!h]
