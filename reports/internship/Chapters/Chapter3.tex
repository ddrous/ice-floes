...
\begin{figure}[!ht]
    ...
    \caption{Illustration du critère de Griffith \parencite{gross2017fracture}. ($\Pi$ et $\Gamma$ représentent les énergie élastiques et de fracture respectivement. \textit{Cette figure est à refaire manuellement!})}
    \label{fig:Griffith}
\end{figure}
