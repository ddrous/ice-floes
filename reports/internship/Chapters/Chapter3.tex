...
\textit{Ci-dessous, QUELQUES IMAGES DE PROCESSUS STOHASTIQUES.}

La première formule de Campbell permet de relier la moyenne d’une somme sur les points du processus avec l’intensité du processus. En effet, soit $f:\mathbb{R}^d \rightarrow \mathbb{R}$ une fonction mesurable et positive, on a :
$$
